...
import { Check, Sparkles, Phone } from "./Icons";
...
const REASONS = [
  ...
  ["Eco-Friendly Products", "green, family-safe cleaning solutions are available for every space."],
    ...
    <section className="section why" id="why">
      ...
      <div className="wrap why-grid">
        <div className="why-art reveal">
          ...
          <span className="clue-marker" aria-hidden="true" style={{ background: "var(--teal)", color: "#fff" }}>
            <Sparkles />
          </span>
        </div>

        <div className="reveal">
          <span className="eyebrow kicker-on-dark">Why Verity Cleaning</span>
          <h2 style={{ marginTop: "12px" }}>Truth &amp; Integrity in Every Clean</h2>
          <p className="lead" style={{ marginTop: "14px" }}>
            "Verity" means truth and authenticity. As a veteran-owned local cleaning service in Shelby County, AL, we operate with transparent standards, strict attention to detail, and a commitment to your satisfaction.
          </p>
          <ul className="checks">
          ...
          <div className="owners">
            <div className="owner">
              <b>Veteran-Owned</b>
              <span>Serving Pelham, Alabaster, Helena, &amp; Hoover</span>
            </div>
            <div className="owner">
              <b>100% Guaranteed</b>
